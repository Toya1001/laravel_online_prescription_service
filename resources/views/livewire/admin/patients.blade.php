            ...
            <div class="-my-8 divide-y-2 divide-gray-100">
                ...
                <div class="py-8 flex flex-wrap md:flex-nowrap">
                    ...
                    <div class="md:flex-grow">
                        ...
                        <button wire:click.prevent="editPatient({{ $patient['id'] }})" type="button" class="border border-indigo-500 bg-black text-white rounded-md px-4 py-2 mx-2 mt-4 transition duration-500 ease select-none hover:bg-indigo-600 focus:outline-none focus:shadow-outline">
                            Edit Patient
                        </button>

        ...
        <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
            <form action="{{ route('register') }}" method="post" class="bg-white">
                ...
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
                    ...
                    <input class="pl-2 outline-none border-none" type="password" name="password_confirmation" id="" placeholder="Confirm Password" />

                </div>
                <div class="block mt-4">
                    <label for="isDoctor" class="inline-flex items-center">
                        <input id="user_type" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="Doctor" name="user_type">
                        <span class="ml-2 text-sm text-gray-600">I'm a Service Provider</span>
                    </label>
                </div>

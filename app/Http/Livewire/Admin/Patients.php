...
class Patients extends Component
{
    ...
    {
        $this->validate();
        Http::withToken('1|DpOFffnn6t6vBt0dsqHFEutbhTpP98I9tIw5TUO8')->post('http://192.168.0.5:8080/api/user', [
        ...
        $data = Http::withToken('1|DpOFffnn6t6vBt0dsqHFEutbhTpP98I9tIw5TUO8')->get('http://192.168.0.5:8080/api/user')->json();
        $data = end($data);
        $userId = reset($data);
       
        Http::withToken('1|DpOFffnn6t6vBt0dsqHFEutbhTpP98I9tIw5TUO8')->post('http://192.168.0.5:8080/api/patient', [
            'user_id' => $userId,
            'mx_no' => $this->mxNo,
            'dob' => $this->dob,
            'gender' => $this->gender,
    ...
    public function editPatient($id)
    {
        ...
        $info = Http::withToken('1|DpOFffnn6t6vBt0dsqHFEutbhTpP98I9tIw5TUO8')->get('http://192.168.0.5:8080/api/patient/' . $id)->json();
        // dd($info);
        ...
        $data = Http::withToken('1|DpOFffnn6t6vBt0dsqHFEutbhTpP98I9tIw5TUO8')->get('http://192.168.0.5:8080/api/user/' . $this->userID)->json();
    ...
    {
        $this->validate();
        Http::withToken('1|DpOFffnn6t6vBt0dsqHFEutbhTpP98I9tIw5TUO8')->put('http://192.168.0.5:8080/api/user/' . $this->userID, [
            'fname' => $this->firstName,
            'lname' => $this->lastName,
            'email' => $this->email,
        ]);

        Http::withToken('1|DpOFffnn6t6vBt0dsqHFEutbhTpP98I9tIw5TUO8')->put('http://192.168.0.5:8080/api/patient/' . $this->patientID, [
            'user_id' => $this->userID,
            'mx_no' => $this->mxNo,
            'dob' => $this->dob,
            'gender' => $this->gender,
    ...
    public function medicalHistory($id)
    {
        $this->history = true;
        // dd($id);
        $this->historyData = Http::withToken('1|DpOFffnn6t6vBt0dsqHFEutbhTpP98I9tIw5TUO8')->get('http://192.168.0.5:8080/api/history/' . $id)->json();
    ...
    public function updateMedicalHistory()
    {
        if (empty($this->medicalHistoryId)) {
            ...
            Http::withToken('1|DpOFffnn6t6vBt0dsqHFEutbhTpP98I9tIw5TUO8')->put('http://192.168.0.5:8080/api/history/' . $this->medicalHistoryId, [
                'patient_id' => $this->patientId,
                'allergies' => $this->allergies,
                'health_conditions' => $this->illness,
                'pregnant_nursing' => $this->pregnant
    ...
    {
        $patient = Http::withToken('1|DpOFffnn6t6vBt0dsqHFEutbhTpP98I9tIw5TUO8')->get('http://192.168.0.5:8080/api/patient')->collect();
        //    dd($patient);

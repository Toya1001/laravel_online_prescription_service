<div>
    <button wire:click.prevent="$set('addPharmacist', true)" type="button" class="border border-indigo-500 bg-black text-white rounded-md px-4 py-2 mx-2 mt-4 transition duration-500 ease select-none hover:bg-indigo-600 focus:outline-none focus:shadow-outline">
        Add Doctor
    </button>
            ...
            <div class="bg-white flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
                <div class="rounded-t bg-white mb-0 px-6 py-6   ">
                    <div class="text-center flex justify-between">
                        ...
                        <i wire:click="$set('addPharmacist', false)" class="fas fa-times text-2xl cursor-pointer"></i>
                    </div>
                </div>
            ...
            <div class="bg-white flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
                <div class="rounded-t bg-white mb-0 px-6 py-6   ">
                    <div class="text-center flex justify-between">
                        ...
                        <i wire:click="$set('editPharmacist', false)" class="fas fa-times text-2xl cursor-pointer"></i>
                    </div>
                </div>
                <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
            ...
            <div class="-my-8 divide-y-2 divide-gray-100">
                ...
                <div class="py-8 flex flex-wrap md:flex-nowrap">
                    <div class="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                        <span class="font-semibold title-font text-gray-700">{{ $pharmacists->user->user_type }}</span>
                        <span class="mt-1 text-gray-500 text-sm">{{ $pharmacists->license_no }}</span>
                    </div>
                    <div class="md:flex-grow">
                        <h2 class="text-2xl font-medium text-gray-900 title-font mb-2">{{ $pharmacists->user->fname }}, {{ $pharmacists->user->lname }}</h2>
                        <p class="leading-relaxed"><span class="font-medium">Company Name: </span> {{ $pharmacists->work_name }}</p>
                        <p class="leading-relaxed"><span class="font-medium">Company Address: </span> {{ $pharmacists->work_address}}</p>

                        <button wire:click.prevent="pharmacistEdit({{ $pharmacists->id }})" type="button" class="border border-indigo-500 bg-black text-white rounded-md px-4 py-2 mx-2 mt-4 transition duration-500 ease select-none hover:bg-indigo-600 focus:outline-none focus:shadow-outline">
                            Edit
                        </button>
                        <button wire:click.prevent="deletePharmacist({{ $pharmacists->id }})" type="button" class="border border-indigo-500 bg-black text-white rounded-md px-4 py-2 mx-2 mt-4 transition duration-500 ease select-none hover:bg-indigo-600 focus:outline-none focus:shadow-outline">
                            Delete
                        </button>
